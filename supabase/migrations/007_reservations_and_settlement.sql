...
alter table public.bids
  ...
  check (status in ('pending', 'paid', 'rejected', 'invalid', 'expired', 'outbid', 'refunded'));
...
-- * Quien cae fuera del top 50 queda con position = null (sigue publicado y
--   activo, para que su dueño pueda volver a ofertar desde su panel).
